...
public class DashboardFrame extends JFrame {
    ...
    public DashboardFrame(main app, User currentUser) {
        this.app = app;
    ...
    private void initComponents() {
        ...
        goalButton = createActionButton("Financial Goals", new Color(155, 89, 182));
    ...
    private void addListeners() {
        ...
        budgetPlanningButton.addActionListener(e -> {
            BudgetPlanningWindow budgetWindow = new BudgetPlanningWindow(currentUser.getUserId());
            budgetWindow.setVisible(true);
        });

        goalButton.addActionListener(e -> {
            GoalWindow goalWindow = new GoalWindow(currentUser.getUserId());
